    	...
    	<div class="wrap ue-clear">
        	<div class="sidebar">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-info">
                    	<div class="nav-header"><a href="javascript:;" class="ue-clear"><span>试题信息管理</span><i class="icon"></i></a></div>
                        <ul class="subnav">
                        	<li><a href="javascript:;" date-src="info-reg.jsp">题目录入</a></li>
                            <!-- <li><a href="worker?who=queryAll" date-src="info-mgt.html">试题管理</a></li>  -->
                            <li><a target="iframe" date-src="<%=request.getContextPath() %>/question?who=queryAll" >试题管理</a></li>
                        </ul>
                    </li>
            ...
            <div class="content">
            	<iframe src="question?who=queryAll" name="iframe" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
    </div>
